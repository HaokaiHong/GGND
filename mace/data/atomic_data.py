...
class AtomicData(torch_geometric.data.Data):
    ...
    def from_config(
        ...
        **kwargs,  # pylint: disable=unused-argument
        ...
        g_edge_index, g_shifts, g_unit_shifts, g_cell = get_neighborhood(
            positions=config.positions,
            # cutoff=cutoff,
            cutoff=10.0,
            pbc=deepcopy(config.pbc),
        ...
        return cls(
            ...
            g_shifts=torch.tensor(g_shifts, dtype=torch.get_default_dtype()),
            g_unit_shifts=torch.tensor(g_unit_shifts, dtype=torch.get_default_dtype()),
            g_cell=g_cell,
        )
